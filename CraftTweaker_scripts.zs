...
//----------Compost Bin----------
//----------------------------------
//Parameters = input, oredictable
//input = the input itemstack
//oredictable = if oredicted versions of the input will be allowed as well
mods.rockhounding_surface.CompostBin.add(<minecraft:dye:0>, true);


//----------------------------------
//---------Wood Incubator-----------
//----------------------------------
//Parameters = input, solute, orectable, solvent, output
