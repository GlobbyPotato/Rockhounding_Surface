...
public class BogLogs extends BaseLog {
    public static final PropertyEnum VARIANT = PropertyEnum.create("variant", EnumBogLogs.class);
    
    public BogLogs(String name, String[] array){
        super(name, array);
        GameRegistry.register(new BaseMetaIB(this, EnumBogLogs.getNames()).setRegistryName(name));
    ...
    public ItemStack createStackedBlock(IBlockState state){
        return new ItemStack(Item.getItemFromBlock(this), 1, ((EnumBogLogs)state.getValue(VARIANT)).ordinal());
    }
