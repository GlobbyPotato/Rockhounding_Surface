...
import com.globbypotato.rockhounding_surface.machines.tileentity.IFluidHandlingTile;
...
public class BaseTileBlock extends BaseMachineBlock implements ITileEntityProvider{
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, @Nullable ItemStack heldItem, EnumFacing side, float hitX, float hitY, float hitZ){
		if (!world.isRemote) {
			...
			player.openGui(Rhsurface.instance, guiID, world, pos.getX(), pos.getY(), pos.getZ());
		}
		return true;
	}
