...
public class ItemBeaker extends ItemBucket {
    public Block isFull;

	public ItemBeaker(String name, Block block, boolean canStack) {
		super(block);
        ...
        if (this.isFull == Blocks.AIR){
            ...
            if (!pos.isAirBlock(posIn) && !flag && !flag1){
                ...
                if (pos.provider.doesWaterVaporize() && this.isFull == Blocks.FLOWING_WATER){
                    ...
                    pos.notifyBlockOfStateChange(posIn, this.isFull.getDefaultState().getBlock());
                }
                return true;
            }
        }
    ...
    public net.minecraftforge.common.capabilities.ICapabilityProvider initCapabilities(ItemStack stack, net.minecraft.nbt.NBTTagCompound nbt) {
        if (this.getClass() == ItemBeaker.class){
