...
import com.globbypotato.rockhounding_surface.items.ArrayIO;
import com.globbypotato.rockhounding_surface.items.GypsumItems;
import com.globbypotato.rockhounding_surface.items.ItemIO;
import com.globbypotato.rockhounding_surface.items.Truffles;
import com.globbypotato.rockhounding_surface.items.food.BaseSeeds;
import com.globbypotato.rockhounding_surface.items.food.ModFood;
import com.globbypotato.rockhounding_surface.items.food.ModSoup;
...
//Fossil woods
		fossilSticks = new ArrayIO("fossilSticks", EnumFossilPlanks.getNames());
//Wood Aging Tech
		if(SupportUtils.rhChemistryLoaded()){
			agingItems = new ArrayIO("agingItems", EnumAgingItems.getNames());
		}
// Truffles
...
// gypsum items
		...
		ricegrassItem = 		new ItemIO("ricegrassItem");		
