...
public class WailaIncubator implements IWailaDataProvider{
		...
		if(te != null){
			if(te instanceof TileEntityWoodIncubator){
				...
				if(tank.inputTank.getFluid() != null){
					currenttip.add(TextFormatting.GRAY + "Content: " + TextFormatting.GOLD + tank.inputTank.getFluid().getLocalizedName());
				}
				currenttip.add(TextFormatting.GRAY + "Storage: " + TextFormatting.RED + tank.inputTank.getFluidAmount() + " / " + tank.inputTank.getCapacity() + " mB");
			}
		}
		return currenttip;
	}
	...
	public static void callbackRegister(IWailaRegistrar registrar) {
		registrar.registerBodyProvider(new WailaIncubator(), WoodIncubator.class);
	}
