...
public class GuiHandler implements IGuiHandler {
	...
	public static final int vivariumID = 3;
	...
	public Object getServerGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
		...
		switch(ID) {
			...
			case compostBinID:
				...
				break;
			case vivariumID:
				if (entity != null && entity instanceof TileEntityVivarium){return new ContainerVivarium(player.inventory, (TileEntityVivarium) entity);}
				break;
		}
        return null;
	}
	...
	public Object getClientGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
		...
		switch(ID) {
			...
			case compostBinID:
				...
				break;
			case vivariumID:
				if (entity != null && entity instanceof TileEntityVivarium){return new GuiVivarium(player.inventory, (TileEntityVivarium) entity);}
				break;
		}
        return null;
	}
