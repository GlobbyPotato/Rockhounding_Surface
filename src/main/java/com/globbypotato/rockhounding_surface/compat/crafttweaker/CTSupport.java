...
public class CTSupport {
    ...
    public static void loadSupport() {
        CraftTweakerAPI.registerClass(CompostRecipes.class);
        CraftTweakerAPI.registerClass(IncubatorRecipes.class);
        CraftTweakerAPI.registerClass(VivariumRecipes.class);
    }
